<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_login.aspx.cs" Inherits="PRJ.admin_login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="gg">
            <div class="left">
                <asp:Image ImageUrl="~/images/admin_IMG.png" runat="server" CssClass="login_img" /><br />
                <asp:Label ID="Label1" runat="server" Text="ADMIN LOGIN" CssClass="label"></asp:Label><br />
